...
export const useAuthStore = defineStore('auth', () => {
  ...
  async function logout(): Promise<void> { const refresh = readRefreshToken(); try { await authApi().logout(refresh || undefined); } finally { clearTokens(); user.value = null; bindingToken.value = ''; } }
